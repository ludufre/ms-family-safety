...
var CONFIG_DIR = (0, import_node_path.join)((0, import_node_os.homedir)(), ".config", "ms-family-safety");
var CONFIG_FILE = (0, import_node_path.join)(CONFIG_DIR, "credentials.json");
function saveCredentials(accessToken, refreshToken, expiresAt) {
  ...
  (0, import_node_fs.writeFileSync)(CONFIG_FILE, JSON.stringify(data, null, 2), { mode: 384 });
}
function loadCredentials() {
  if (!(0, import_node_fs.existsSync)(CONFIG_FILE)) return null;
  try {
    const data = JSON.parse((0, import_node_fs.readFileSync)(CONFIG_FILE, "utf-8"));
